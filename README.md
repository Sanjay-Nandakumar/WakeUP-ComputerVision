...
**WakeUp is a computer vision project done for learning purposes of drowsiness detection in the human face. The front end is built using Django and the back end has been fed with various deep learning libraries such as OpenCV, Keras, and Pygame.** 
